# Generated by Django 3.2 on 2023-12-12 14:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exist'}, help_text='Required. 30 characters or fewer starting with a letter. letters', max_length=32, unique=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z][a-zA-Z0-9_\\.]+S', 'Enter a valid username starting with a-z. This value my contain only letters, numbersand underscore characters.', 'invalid')], verbose_name='username')),
                ('first_name', models.CharField(blank=True, max_length=30, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=30, verbose_name='last name')),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True, verbose_name='email address')),
                ('phone_number', models.BigIntegerField(blank=True, error_messages={'unique': 'A user with this mobile number already exists'}, null=True, unique=True, validators=[django.core.validators.RegexValidator('^989[0-3,9]\\d{8}S', 'enter a valid mobile number.')], verbose_name='mobile number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type', models.PositiveIntegerField(choices=[(1, 'web'), (2, 'ios'), (3, 'android')], default=1)),
